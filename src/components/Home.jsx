...
class Home extends React.Component{
    state = {date: addDays(new Date(), 14), budget: '12000', departure: '1', duration: '90', plans: null, planCount: null, error: null, loading: false}
    ...
    onFormSubmit = async (event) => {
        try {
            ...
            const response = await axios.get('https://9ody130jol.execute-api.ap-northeast-1.amazonaws.com/production/golf-courses', {
            ...
            <div className= "ui container" id="container">
                <div className="Serch__Form">
                    <form className="ui form segment" onSubmit={this.onFormSubmit}>
                        ...
                        <div className="field">
                            <label><i className="map pin icon"></i>上限金額</label>
